...
const BannerUSPComponent = () => {
    return (
        <div>
            <>
                {/* Main Container */}
                <div className='h-96 flex items-start justify-between bg-amber-950'>
                    {/* 1st USP */}
                    <div className='text-center'>
                        ...
                        <div className='text-white text-xl font-bold mb-2'>No Minimum Order</div>
                    ...
                    <div className='text-center'>
                        ...
                        <div className='text-white text-xl font-bold mb-2'>Live Order Tracking</div>
                        <div className='text-slate-300 text-sm mb-2'>
                    ...
                    <div className='text-center'>
                        ...
                        <div className='text-white text-xl font-bold mb-2'>Lightning-Fast Delivery</div>
                        <div className='text-slate-300 text-sm mb-2'>
