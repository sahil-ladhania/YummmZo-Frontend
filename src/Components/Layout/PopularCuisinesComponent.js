            ...
            <>
                ...
                <div className='flex flex-col items-center justify-center h-auto'>
                    ...
                    <div className='mb-10 mt-10'>
                        <h2 className='text-3xl font-roboto text-yummmzo-color'>Popular Cuisines</h2>
                    </div>
                    {/* Cuisines Section */}
                    <div>
                        <div className='flex justify-center fw-w flex-wrap cursor-pointer'>
                            {cuisines.map((cuisine, index) => (
                                <div key={index} className='flex mb-5 mt-5 flex-col items-center mr-8 ml-8'>
                                    ...
                                    <a className='text-sm font-medium font-roboto text-yummmzo-color' href="#">{cuisine.cuisineName}</a>
                                </div>
                            ))}
                        </div>
                    </div>
