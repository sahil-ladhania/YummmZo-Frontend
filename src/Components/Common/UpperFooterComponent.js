...
const UpperFooterComponent = () => {
    return (
        <div>
            <>
                {/* Main Component */}
                <div className='flex justify-between items-start h-auto mb-2 pt-20 pb-5'>
                    {/* First Column */}
                    <div className=''>
                        {/* Heading */}
                    ...
                    <div className=''>
                        {/* Heading */}
                        <div className='mb-5 font-medium uppercase font-roboto font-medium text-yummmzo-color'>
                            contact
                        </div>
                        <div className=''>
                            <ul className='leading-8'>
