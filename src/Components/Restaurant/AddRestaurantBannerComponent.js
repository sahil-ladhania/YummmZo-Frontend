...
const AddRestaurantBannerComponent = () => {
    return (
        <div className="relative mb-5">
            ...
            <Link to="/registerRestaurant" className='absolute flex items-center justify-center bottom-5 ml-5 mb-10 left-0  pt-2 pb-2 w-32 bg-white text-black rounded-sm'>
