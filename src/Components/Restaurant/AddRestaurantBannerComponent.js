...
const AddRestaurantBannerComponent = () => {
    return (
        <div className="relative pb-10">
            ...
            <Link to="/registerRestaurant" className='absolute flex items-center justify-center bottom-5 ml-5 mb-10 left-0  pt-2 pb-2 w-32 bg-signup-gradient text-white rounded-sm hover:animate-glow-light'>
                <span className='mr-2 text-white'>Start now</span>
                <span><CiCircleChevRight className='text-xl text-white'/></span>
            </Link>
        </div>
    );
};
