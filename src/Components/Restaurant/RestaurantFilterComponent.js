                    ...
                    <div className='w-9/12 flex justify-between'>
                        {
                            isFastDeliveryActive ? 
                                ...
                                <>
                                    ...
                                    <div onClick={handleFastDelivery} className='flex items-center bg-button-color  pr-3 pl-3 pt-2 pb-2 rounded-sm cursor-pointer hover:animate-glow-light'>
                                        <CiClock2 className='text-xl mr-1 ml-1 text-secondary'/>
                                        <a className='text-sm font-roboto text-secondary' href="#">Fast Delivery</a>
                                    </div>
                                </>
                        }
                        {
                            isRatingActive ? 
                                ...
                                :
                                <>
                                    <div onClick={handleRating} className='flex items-center bg-button-color pr-3 pl-3 pt-2 pb-2 rounded-sm cursor-pointer hover:animate-glow-light'>
                                        <CiStar className='text-xl mr-1 ml-1 text-secondary'/>
                                        <a className='text-sm font-roboto text-secondary' href="#">Rating</a>
                                    </div>
                                </>
                        }
                        {
                            isCostLTHActive ?
                                ...
                                :
                                <>
                                    <div onClick={handleCostLTH} className='flex items-center bg-button-color pr-3 pl-3 pt-2 pb-2 rounded-sm cursor-pointer hover:animate-glow-light'>
                                        <CiCircleChevUp className='text-xl mr-1 ml-1 text-secondary'/>
                                        <a className='text-sm font-roboto text-secondary' href="#">Cost : Low to High</a>
                                    </div>
                                </>
                        }
                        {
                            isCostHTLActive ?
                                ...
                                :
                                <>
                                    <div onClick={handleCostHTL} className='flex items-center bg-button-color pr-3 pl-3 pt-2 pb-2 rounded-sm cursor-pointer'>
                                        <CiCircleChevDown className='text-xl mr-1 ml-1 text-secondary'/>
                                        <a className='text-sm font-roboto text-secondary' href="#">Cost : High to Low</a>
                                    </div>
                                </>
                        }
                    </div>
