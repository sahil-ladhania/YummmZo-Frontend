            ...
            <>
                ...
                <div>
                    <div className='flex flex-col justify-center items-center h-screen'>
                        ...
                        <Link to="/home" className='flex items-center justify-center h-10 pr-3 pl-3 pt-2 pb-2 rounded-sm bg-button-color hover:animate-glow-light'>
                            <span><CiCircleChevLeft className='text-2xl mr-2'/></span>
                            <span className='fs-r fs-m font-roboto'>Back to Home</span>
                        </Link>
                    </div>
                </div>
            </>
